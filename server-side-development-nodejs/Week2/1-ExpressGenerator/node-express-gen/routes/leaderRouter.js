...
leaderRouter.route('/:leadershipId')
  ...
  .put(function (req, res, next) {
    res.write('Insert the leadership: ' + req.params.leadershipId + '\n')
    res.end('Will insert the leadership: ' + req.body.name + ' with details: ' + req.body.description)
  })
  .post(function (req, res, next) {
  ...
  .delete(function (req, res, next) {
    res.end('Deleting the leadership: ' + req.params.leadershipId)
  })
